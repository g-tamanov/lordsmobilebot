...
def closeAll():
    while exists(Template(r"tpl1631618318759.png", record_pos=(0.153, -0.231), resolution=(1280, 720)))!=False:
        ...
        sleep(2.0)
def checkCastleMap():
    if exists(Template(r"tpl1631627327541.png", record_pos=(-0.473, 0.172), resolution=(1280, 720)))!=False and exists(Template(r"tpl1631625805932.png", record_pos=(-0.435, 0.24), resolution=(1280, 720)))==False:
    ...
    if exists(Template(r"tpl1631701085679.png", record_pos=(0.057, 0.245), resolution=(1280, 720)))!=False:
        ...
        if exists(Template(r"tpl1631701188651.png", record_pos=(-0.001, -0.102), resolution=(1280, 720)))!=False:
            ...
            if exists(Template(r"tpl1631701201936.png", record_pos=(-0.006, 0.193), resolution=(1280, 720)))!=False:
                ...
                sleep(1)
                if exists(Template(r"tpl1631474241345.png", record_pos=(-0.115, -0.004), resolution=(1072, 693)))!=False:
...
def openChest():
    closeAll()
    if exists(Template(r"tpl1631368754416.png", record_pos=(0.409, 0.152), resolution=(1255, 753)))!=False and exists(Template(r"tpl1631623157409.png", record_pos=(0.392, 0.145), resolution=(1280, 720)))==False:
...
def guildGifts():
    ...
    if exists(Template(r"tpl1631470836711.png", record_pos=(0.392, -0.153), resolution=(1072, 693)))!=False or exists(Template(r"tpl1631470809764.png", record_pos=(0.392, -0.153), resolution=(1072, 693)))!=False:
        ...
        if exists(Template(r"tpl1631384942057.png", record_pos=(0.252, -0.077), resolution=(1280, 720)))!=False:
            ...
            sleep(1.0)
            while exists(Template(r"tpl1631385034677.png", record_pos=(0.364, -0.044), resolution=(1280, 720)))!=False:
...
def upgradeAllFarms():
    closeAll()
    if exists(Template(r"tpl1631700026528.png", record_pos=(0.18, 0.028), resolution=(1280, 720)))!=False or exists(Template(r"tpl1631700045672.png", record_pos=(0.043, -0.005), resolution=(1280, 720)))!=False or exists(Template(r"tpl1631700066140.png", record_pos=(0.098, -0.073), resolution=(1280, 720)))!=False or exists(Template(r"tpl1631700106204.png", record_pos=(0.058, 0.0), resolution=(1280, 720)))!=False and exists(Template(r"tpl1631713263616.png", record_pos=(0.218, 0.054), resolution=(1280, 720)))!=False:
...
def upgrade():
    if exists(Template(r"tpl1631698911711.png", record_pos=(0.358, 0.218), resolution=(1280, 720)))!=False:
        ...
        if exists(Template(r"tpl1631699030898.png", record_pos=(0.134, 0.19), resolution=(1280, 720)))!=False:
            ...
            sleep(1)
            if exists(Template(r"tpl1631699109306.png", record_pos=(-0.001, -0.164), resolution=(1280, 720)))!=False and exists(Template(r"tpl1631699121522.png", record_pos=(-0.009, -0.015), resolution=(1280, 720)))!=False:
                touch(Template(r"tpl1631699121522.png", record_pos=(-0.009, -0.015), resolution=(1280, 720)))
                while exists(Template(r"tpl1631699180173.png", record_pos=(0.305, -0.136), resolution=(1280, 720)))!=False:
